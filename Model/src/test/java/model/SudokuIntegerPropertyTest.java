...
public class SudokuIntegerPropertyTest {
    ...
    void testIntegerProperty() {
        ...
        SudokuField fieldtest = new SudokuField(3);
        test.solveGame();
        test.set(0,0,3);
        assertEquals(test.getFieldProperty(0).getValue(),fieldtest.getProperty().getValue());
